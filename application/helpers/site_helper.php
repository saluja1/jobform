...
function generic_select($tbl, $conditions = null, $orderBy = null, $limit = null,
    $start = 0)
{
    $ci = &get_instance();
...
function getDistinct($tbl, $distinctField, $conditions = null, $orderBy = null,
    $limit = null, $start = 0)
{
    $ci = &get_instance();
    return $ci->generic_model->getDistinct($tbl, $distinctField, $conditions, $orderBy,
        $limit, $start);
}
...
{
    return !(trim($field) === '' || $field === null || $field == '0000-00-00' || $field ==
        '0');
}
...
function get_status_color($status)
{
    switch ($status) {
        case 'Done':
            ...
            break;
        case 'Checked':
            return 'checked'; //Yellow
            break;
        case 'Delivered':
            return 'delivered'; //Green
            break;
        case 'Disposed':
            return 'disposed'; //Blue
            break;
        default:
            return 'not_done'; //White
    }
}
