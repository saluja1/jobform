        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td width="45%" style="border-right: solid 0px #000; border:solid 1px #000;">
                    <img style="width:100%;" src="<?php echo base_url('adminfiles/img/logo.jpg')?>" alt="" />
                </td>
                <td style="background-color:#d8d8d8; padding:10px 50px; box-sizing:border-box; border:solid 1px #000;">
                    <h1 style="margin:0; font-size:16px;">Budget Mobiles & Computers Limited</h1>
            ...
            <tr>
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" style="border:solid 1px #000; padding:10px; line-height:30px; border-bottom:solid 0px #000;">
                        <tr>
            ...
            <tr>
                <td colspan="2">
                    <table width="100%" cellpadding="0" cellspacing="0" style="border:solid 1px #000; padding:10px; line-height:30px; border-bottom:solid 1px #000;">
                        <tr>
