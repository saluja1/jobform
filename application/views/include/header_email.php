...
*/
    ...
    .login-box {
        background: linear-gradient(to bottom, rgba(245, 245, 245, 1) 0%, rgba(255, 255, 255, 1) 19%, rgba(255, 255, 255, 1) 77%, rgba(245, 245, 245, 1) 100%) repeat scroll 0 0 rgba(0, 0, 0, 0);
        box-shadow: 7px 18px 35px 17px rgba(0, 0, 0, 0.23);
        color: #475546;
        margin: 100px auto;
        overflow: hidden;
        width: 400px;
